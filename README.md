...
`${GOPATH}/src/github.com/JustinChen1975/intbeat`
...
```
git remote set-url origin https://github.com/JustinChen1975/intbeat
...
in the same directory with the name intbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/JustinChen1975/intbeat
git clone https://github.com/JustinChen1975/intbeat ${GOPATH}/src/github.com/JustinChen1975/intbeat
```
